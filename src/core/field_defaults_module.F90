MODULE FIELD_DEFAULTS_MODULE
  ...
  INTEGER :: POOL_ALLOC_PADDING_FACTOR = 256
  INTEGER(KIND=INT64) :: HST_POOL_BLOCK_SIZE = 3_INT64*1024_INT64*1024_INT64*1024_INT64 ! 3Gb
  INTEGER(KIND=INT64) :: DEV_POOL_BLOCK_SIZE = 512_INT64*1024_INT64*1024_INT64 ! 512Mb
...
! IF SET TO FALSE, GET_VIEW WILL MOVE THE DATA ON CPU IF THEY ARE NOT PRESENT
  ...
  NAMELIST / NAMFIELD_API / &
   ...
   & HST_POOL_BLOCK_SIZE,   NUM_ASYNC_QUEUES,               &
   & USE_DEVICE_MEM_POOL,   DEV_POOL_BLOCK_SIZE
